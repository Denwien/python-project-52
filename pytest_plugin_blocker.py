...
if pluggy:
    ...
    def _patch_pluggy_when_imported():
        spec = importlib.util.find_spec("pluggy")
    ...
    sys.meta_path.insert(0, type('PytestPluginBlocker', (), {
        'find_spec': lambda self, name, path, target=None: (
            _patch_pluggy_when_imported() if name == 'pluggy' else None
        )
    })())
